...
![高校野球部のグラウンドでの練習風景](IMAGE_PLACEHOLDER:high-school-baseball-practice)
...
![保護者と子どもが一緒にスケジュールを確認している場面](IMAGE_PLACEHOLDER:parent-child-study-planning)
...
![進路について前向きに考える中高生のイメージ](IMAGE_PLACEHOLDER:student-career-planning)
...
:::cta-nobilva
title: 野球とスポーツ推薦対策、‖どちらも諦めない学習管理を。
description: Nobilvaは、野球をがんばる中高生のための学習管理サービスです。‖週ごとの日割り学習計画・週1回のオンライン面談・毎日の進捗確認で、‖練習と勉強の両立を全力サポートします。‖スポーツ推薦に必要な評定維持のための個別戦略も一緒に考えます。‖月18,000円〜・30日全額返金保証。‖まずは無料学習診断（月20名限定）をご利用ください。
