      ...
      <div className="mb-6">
        <FilterTabs
          ...
          tabs={[
            ...
            { key: "published", label: "公開済み", count: posts.filter((p) => p.published !== false).length },
            { key: "draft", label: "下書き", count: posts.filter((p) => p.published === false).length },
          ]}
        />
      </div>
          ...
          <table className="w-full min-w-[900px]">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="text-left py-3 px-4 text-sm font-semibold text-gray-900 w-[120px]">
                  カテゴリ
                </th>
                ...
                <th className="text-right py-3 px-4 text-sm font-semibold text-gray-900 w-[120px]">
                  操作
                </th>
              </tr>
            </thead>
