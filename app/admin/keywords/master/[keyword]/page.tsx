    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-soft p-6">
          ...
          <p className="text-3xl font-bold text-gray-900">{data.assignedArticles.length}</p>
        ...
        <div className="bg-white rounded-2xl shadow-soft p-6">
          ...
          <p className="text-3xl font-bold text-gray-900">{data.rankHistory.length}</p>
          ...
          <div className="bg-white rounded-2xl shadow-soft-lg p-6">
            ...
            {data.rankHistory.length === 0 ? (
              ...
              <div className="space-y-3">
                {data.rankHistory.slice().reverse().map((entry, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-4 bg-gray-50 rounded-lg"
                  >
                    <div>
                      <p className="font-semibold text-gray-900">{entry.rank}位</p>
