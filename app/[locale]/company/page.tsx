...
export default async function CompanyPage({
  ...
  const tValues = await getTranslations({ locale, namespace: 'company.values' });
  ...
  return (
    <div className="bg-pink-light min-h-screen">
      {/* Hero Section */}
      <Section backgroundColor="white" padding="none" className="pt-32 md:pt-48 pb-12 md:pb-16">
        <Container>
          <ScrollReveal>
      ...
      {/* History, Company Information */}
          <HistorySection backgroundColor="white" />
                ...
                <ScrollReveal delay={0.2}>
                  <BaseCard>
                    <div className="flex gap-4">
                      <div className="bg-pink-light rounded-2xl py-4 md:py-5 px-2 md:px-3 flex flex-col items-center justify-center min-w-[70px] md:min-w-[90px]">
                      ...
                      <div className="flex items-center flex-1">
                        <p className="text-text text-lg md:text-xl">{tInfo('tradeNameValue')}</p>
                      </div>
                    </div>
                  </BaseCard>
                </ScrollReveal>
                <ScrollReveal delay={0.3}>
                  <BaseCard>
                    <div className="flex gap-4">
                      ...
                      <div className="flex items-center flex-1">
                        <p className="text-text text-lg md:text-xl">{tInfo('representativeValue')}</p>
                      </div>
                    </div>
                  </BaseCard>
                </ScrollReveal>
                <ScrollReveal delay={0.4}>
                  <BaseCard>
                    <div className="flex gap-4">
                      ...
                      <div className="flex items-center flex-1">
                        <p className="text-text text-lg md:text-xl">{tInfo('phoneValue')}</p>
                      </div>
                    </div>
                  </BaseCard>
                </ScrollReveal>
