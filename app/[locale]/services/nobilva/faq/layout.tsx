...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "野球以外の部活でも利用できますか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "はい、ご利用いただけます。Nobilva は野球をがんばる中高生を中心にサポートしていますが、学習計画・週1面談・毎日の進捗確認という仕組みは部活動全般に対応しています。サッカー・バスケットボールなど他の部活動に取り組む生徒も受け入れており、練習や大会のスケジュールを伺ったうえで、同じように日割りの計画を作成します。",
      },
    },
  ],
};
