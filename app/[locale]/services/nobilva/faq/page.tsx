...
const PARENT_FAQ = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "はい。Nobilva は野球をがんばる中高生を主な対象として設計していますが、他のスポーツや部活動に取り組まれている方も歓迎しています。無料学習相談で具体的な状況を伺ったうえで、最適なご提案をします。",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: "申込みの流れを教えてください",
        a: "1. 無料学習相談に申込み → 2. 24時間以内に面談日時の確定メールが届く → 3. オンラインで30分の面談 → 4. ご検討期間を経て正式申込み → 5. サービス開始。",
      },
      {
        q: "無料学習相談は本当に無料ですか？",
...
const STUDENT_FAQ = [
  {
    ...
    items: [
      {
        q: "自分で勝手に申し込んでいいの？",
        a: "いいです。Nobilva は生徒本人からの申込みも受け付けています。無料学習相談のフォームで、お申し込み者欄に自分の名前を書いてください。ただし、契約・料金支払いは保護者の方を経由する形になるため、最終的にはご家族に話す必要があります。",
      },
      {
        q: "診断の面談、親がいないと話せない？",
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <SubpageCTA
        ...
        description="個別の状況に応じたご提案は、/無料学習相談または/お問い合わせフォームで/お受けします。"
        secondaryLinks={[
          {
            label: "チーム導入のお問い合わせ",
