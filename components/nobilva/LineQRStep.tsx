        ...
        <div className="flex gap-4 md:gap-6 relative">
          ...
          <div className="pt-1 flex-1">
            ...
            <div className="flex flex-col">
              {/* QRコードとボタンを横並び（md以上） */}
              <div className="flex flex-col md:flex-row lg:flex-row gap-4 md:gap-6 lg:gap-6 items-center">
                {/* QRコード */}
                ...
                <div className="hidden lg:flex flex-1 items-center justify-center">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-line text-white rounded-none p-4 shadow-md hover:shadow-lg transition-all hover:scale-105 flex items-center justify-center gap-2 text-center font-bold text-lg whitespace-nowrap"
                  >
                    <svg
                      className="w-7 h-7"
                      viewBox="0 0 24 24"
