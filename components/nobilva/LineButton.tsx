/**
 * LineButton - LINE友だち追加ボタンコンポーネント
 * 
 * LINE友だち追加へのリンクボタン
 * 複数のサイズバリエーションをサポート
 */
...
export function LineButton({
  ...
  return (
    <a
      ...
      className={`bg-line text-white rounded-none ${paddingClasses[size]} shadow-md hover:shadow-lg transition-all hover:scale-105 flex items-center justify-center gap-2 text-center font-bold ${textClasses[size]} whitespace-nowrap ${className}`}
    >
      <svg
