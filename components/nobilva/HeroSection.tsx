...
export function HeroSection({ sports }: HeroSectionProps) {
            ...
            <div className="flex-1 space-y-6 md:space-y-8 max-w-none">
                  ...
                  >
                    {isJapanese ? (
                      <>
                        ...
                        <PriceDisplay
                          price={t("hero.price.amount")}
                          size="large"
                          className="-ml-1 md:-ml-2"
                          gradientColors={{ start: "#bb4510", end: "#ea5614" }}
                        />
                        <span className="text-2xl md:text-4xl lg:text-5xl">
                          {t("hero.price.currency")}
                        </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                <FeatureCard
                  ...
                  title={t("hero.benefits.weekly")}
                  variant="hero"
                  iconColor="text-nobilva-accent"
                />
                <FeatureCard
                  icon={HiOutlineChatAlt2}
                  title={t("hero.benefits.chat")}
                  variant="hero"
                  iconColor="text-nobilva-accent"
                />
                <FeatureCard
                  icon={HiOutlineAcademicCap}
                  title={t("hero.benefits.tutoring")}
                  variant="hero"
                  iconColor="text-nobilva-accent"
                />
              </div>
