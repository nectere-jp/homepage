  ...
  return (
    <div className="fixed right-0 bottom-0 z-50 hidden lg:flex items-center">
      ...
      <a
        ...
        className={`flex items-center justify-center bg-gradient-to-b from-teachit-accent to-teachit-accent/80 text-white shadow-lg hover:shadow-xl transition-all hover:scale-105 rounded-tl-[2rem] rounded-bl-[2rem] ${
