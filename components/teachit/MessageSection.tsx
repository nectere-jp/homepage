...
export function MessageSection() {
  ...
  // 翻訳ファイルからハイライト設定を取得
  const titleHighlight = t.raw("titleHighlight") as {
    text: string;
    color: string;
  } | null;
  const subtitleHighlight = t.raw("subtitleHighlight") as {
    text: string;
    color: string;
  } | null;
  const descriptionHighlight = t.raw("descriptionHighlight") as {
    text: string;
    color: string;
  } | null;
