...
export function ServiceIconCard({ 
  ...
  return (
    ...
    >
      <Icon className={cn(`${iconColor} mb-1.5 flex-shrink-0`, iconSizes[variant])} />
      <span 
        className={cn('font-bold text-text text-center leading-tight', textSizes[variant])}
        style={{ wordBreak: 'keep-all', overflowWrap: variant === 'pricing' ? 'break-word' : 'normal' }}
      >
